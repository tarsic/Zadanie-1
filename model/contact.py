...
class Contact:
    ...
    def __init__(self, firstname=None, middlename=None, lastname=None, homephone=None, mobilephone=None,
                 workphone=None, email=None, email2=None, email3=None, secondaryphone=None,
                 all_phones_from_home_page=None, all_phones_from_edit_page=None,
                 all_emails_from_home_page=None,
                 nickname=None, company=None, address=None, id=None):
